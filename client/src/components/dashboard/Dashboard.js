...
const Dashboard = ({
  ...
  return loading && profile == null ? (
    ...
    <Fragment>
      ...
      <p className='lead'>
        <i className='fab fa-angellist'></i>Welcome {user && user.firstname}
      </p>
      {profile !== null ? (
        <Fragment>
          ...
          {/* Custon shape divider at the bottom of the page */}
          <div className='custom-shape-divider-bottom-1592107561'>
            <svg
              data-name='Layer 1'
